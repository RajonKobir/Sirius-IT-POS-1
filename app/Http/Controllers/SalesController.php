            ...
            foreach ($sales as $sale) {
                ...
                $item['action'] = '<div class="dropdown">
                        ...
                        if ($user_auth->can('sales_delete') &&  $sale_has_return == 'no'){
                            $item['action'] .= '<a class="dropdown-item delete cursor-pointer rajon" id="' .$sale->id. '" > <i class="nav-icon i-Close-Window font-weight-bold mr-2"></i> ' .trans('translate.DeleteSale').'</a>';
                        }
