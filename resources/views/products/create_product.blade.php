                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4" v-if="product.type != 'is_service'">
                            ...
                            <input type="number" min="0" step="0.01" class="form-control" id="qty_min"
                        ...
                        <div class="form-group col-md-4" v-if="product.type != 'is_service'">
                            ...
                            <input type="number" min="0" step="0.01" class="form-control" id="stock_alert"
                                placeholder="{{ __('translate.Enter_Stock_alert') }}" v-model="product.stock_alert">
                        </div>

                        <div class="form-group col-md-4" v-if="product.type != 'is_service' && product.type != 'is_variant'">
                            <label for="stock">{{ __('translate.CurrentStock') }} <span class="field_required">*</span></label>
                            <input type="number" min="0" step="0.01" class="form-control" id="stock"
                                placeholder="{{ __('translate.Enter_Stock') }}" v-model="product.stock" required>
                        </div>
                                ...
                                <table class="table table-hover table-sm">
                                    <thead class="bg-gray-300">
                                        <tr>
                                            ...
                                            <th scope="col">{{ __('translate.CurrentStock') }}</th>
                                            <th scope="col"></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr v-for="variant in variants">
                                           <td>
                                            ...
                                            <td>
                                                <input required class="form-control" v-model="variant.stock">
                                            </td>
                                            <td>
