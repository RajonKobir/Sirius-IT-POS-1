  ...
  Vue.component('validation-observer', VeeValidate.ValidationObserver);
    ...
    add_product() {
      ...
      if(this.product.qty_min > this.product.fix_stock){
          toastr.error('Minimum quantity '+ ' ' + '('+this.product.qty_min + ' ' + this.product.unitSale+')' + ' '+ 'Mais n\'est pas suffisant en stock');
        }else{
            ...
            if (this.details.length <= 0) {
              ...
              for (var i = 0; i < this.details.length; i++) {
                if (
                  ...
                  toastr.error('The minimum sales quantity for the product' + ' ' + this.details[i].name + '  est' + ' '+ this.details[i].qty_min +' ' + this.details[i].unitSale);
                  return false;
                }
              }
              if (count > 0) {
